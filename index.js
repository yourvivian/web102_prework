...
<p>${numContributions.toLocaleString()}</p>
`;
...
const displayStr = `
$${numContributions.toLocaleString()} has been raised for ${numGames} games. Currently, ${numUnfunded} ${numUnfunded > 1 ? 'games remain' : 'game remains'} unfunded.
`;
...
firstGameElement.textContent = `Top Pledge Game: ${mostFundedGame.name}`;
firstGameContainer.appendChild(firstGameElement);

// do the same for the runner up item
const secondGameElement = document.createElement("div");
secondGameElement.textContent = `Runner-Up Game: ${secondMostFundedGame.name}`;
